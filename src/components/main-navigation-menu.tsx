    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="bg-background grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
     ...
     <img src="/one.svg" alt="ONE logo" className="size-40" />
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="bg-background grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
